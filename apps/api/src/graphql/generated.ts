...
export type GqlBookingResolvers<
  ContextType = Context,
  ParentType extends GqlResolversParentTypes["Booking"] =
    GqlResolversParentTypes["Booking"],
> = ResolversObject<{
  ...
  status?: Resolver<
    GqlResolversTypes["BookingStatus"],
    ParentType,
    ContextType
  >;
...
export type GqlHotelResolvers<
  ContextType = Context,
  ParentType extends GqlResolversParentTypes["Hotel"] =
    GqlResolversParentTypes["Hotel"],
> = ResolversObject<{
...
> = ResolversObject<{
  cancelBooking?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<GqlMutationCancelBookingArgs, "bookingId">
  >;
  confirmBooking?: Resolver<
    GqlResolversTypes["Boolean"],
    ParentType,
    ContextType,
    RequireFields<GqlMutationConfirmBookingArgs, "bookingId">
  >;
  createBooking?: Resolver<
    GqlResolversTypes["Booking"],
    ParentType,
    ContextType,
    RequireFields<
      GqlMutationCreateBookingArgs,
...
> = ResolversObject<{
  booking?: Resolver<
    Maybe<GqlResolversTypes["Booking"]>,
    ParentType,
    ContextType,
    RequireFields<GqlQueryBookingArgs, "id">
  >;
  bookings?: Resolver<
    Array<GqlResolversTypes["Booking"]>,
    ParentType,
    ContextType,
    RequireFields<GqlQueryBookingsArgs, "roomId">
  >;
  hotel?: Resolver<
    Maybe<GqlResolversTypes["Hotel"]>,
    ParentType,
    ContextType,
    RequireFields<GqlQueryHotelArgs, "id">
  >;
  hotels?: Resolver<Array<GqlResolversTypes["Hotel"]>, ParentType, ContextType>;
  room?: Resolver<
    Maybe<GqlResolversTypes["Room"]>,
    ParentType,
    ContextType,
    RequireFields<GqlQueryRoomArgs, "id">
  >;
  rooms?: Resolver<
    Array<GqlResolversTypes["Room"]>,
    ParentType,
    ContextType,
    RequireFields<GqlQueryRoomsArgs, "hotelId">
  >;
}>;

export type GqlRoomResolvers<
  ContextType = Context,
  ParentType extends GqlResolversParentTypes["Room"] =
    GqlResolversParentTypes["Room"],
> = ResolversObject<{
  bookings?: Resolver<
    Array<GqlResolversTypes["Booking"]>,
    ParentType,
  ...
  isAvailable?: Resolver<
    ...
    ParentType,
    ContextType,
    Partial<GqlRoomIsAvailableArgs>
  >;
  name?: Resolver<GqlResolversTypes["String"], ParentType, ContextType>;
...
export type GqlSubscriptionResolvers<
  ContextType = Context,
  ParentType extends GqlResolversParentTypes["Subscription"] =
    GqlResolversParentTypes["Subscription"],
> = ResolversObject<{
  bookingStatusChanged?: SubscriptionResolver<
    GqlResolversTypes["Booking"],
    "bookingStatusChanged",
    ParentType,
    ContextType,
    RequireFields<GqlSubscriptionBookingStatusChangedArgs, "roomId">
  >;
}>;
