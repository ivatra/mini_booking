...
export const apiRoutes: FastifyPluginAsync = async (app) => {
  ...
  const bookingService = new BookingService(roomService, hotelService);
  ...
  await app.register(createHotelRoutes(hotelController), { prefix: "/hotels" });
  await app.register(createRoomRoutes(roomController), { prefix: "/rooms" });
